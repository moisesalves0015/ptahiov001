        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[10px] font-medium text-accent uppercase tracking-wider truncate">{quote.category}</p>
            </div>
          ...
          <p className="mt-2 text-xs text-primary/50 truncate leading-relaxed">
            {quote.description}
          </p>
