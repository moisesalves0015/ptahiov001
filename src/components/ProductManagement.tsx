    ...
    <div className="p-6 pb-32 space-y-8 bg-background min-h-screen">
      ...
      <section className="flex items-center justify-between">
        ...
        <button 
          ...
          className="p-4 bg-primary text-accent rounded-lg shadow-xl shadow-slate-900/10 active:scale-90 transition-all"
        >
          <Plus size={20} />
        </button>
      </section>
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-2 p-1.5 bg-white border border-slate-100 rounded-lg shadow-sm">
            <button 
              ...
              className={`p-2.5 rounded-md transition-all ${viewMode === 'grid' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-slate-600'}`}
            >
              <LayoutGrid size={18} />
            </button>
            <button 
              onClick={() => setViewMode('list')}
              className={`p-2.5 rounded-md transition-all ${viewMode === 'list' ? 'bg-primary text-white shadow-md' : 'text-slate-400 hover:text-slate-600'}`}
            >
              <ListIcon size={18} />
            </button>
          </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-2.5 text-slate-400 hover:text-primary hover:bg-slate-50 rounded-md transition-all">
                          <Edit2 size={18} />
                        </button>
      ...
      {/* Stats Summary */}
      <section className="bg-primary rounded-xl p-8 text-white shadow-2xl shadow-slate-900/20 relative overflow-hidden">
