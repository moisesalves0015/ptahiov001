        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between">
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[10px] font-medium text-primary/60 uppercase tracking-wider truncate">Qtd: {quote.quantity}</p>
            </div>
          ...
          <div className="mt-3 flex items-center gap-3 text-[10px] font-medium text-primary/60 whitespace-nowrap">
